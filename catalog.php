...
foreach ($categories as $c) {
	if ($c['category'] == $catalog) {
		$is = 1;
	}
}?>
<?php if ($is == 1):
$catalogid = R::getCell('SELECT id FROM categories WHERE category = "'.$catalog.'"');
$goods = R::getAll("SELECT * FROM goods WHERE category = ".$catalogid);
			...
			<div class="slider">
				<div class="container-fluid">
				  <div id="myCarousel" class="carousel slide" data-ride="carousel">
				    ...
				    <div class="carousel-inner">
				      <div class="item active">
				        <div class="row">
				        	...
				        	<?php if ($brands[2]['name'] != NULL): ?><div class="col-xs-5 col-xs-offset-1 col-sm-2 col-md-2 vert-align-center">
					...
					<?php if ($brands[4]['name'] != NULL): ?> 
				      <div class="item">
				        <div class="row">
				        	...
				        	<?php if ($brands[7]['name'] != NULL): ?><div class="col-xs-5 col-xs-offset-1 col-sm-2 vert-align-center">
				    ...
				    <?php if ($brands[4]['name'] != NULL): ?><a class="left carousel-control" href="#myCarousel" data-slide="prev">
