	...
	<body>
		...
		<div class="admin-nav">
		    <ul class="hidden-sm hidden-xs">
		        ...
		        <a href="list/news.php"><li>Новини</li></a>
		        <a href="list/users.php"><li>Користувачі</li></a>
		        <a href="brands.php" class="admin-nav-active-tab"><li>Бренди</li></a>
		    </ul>
		    <div class="admin-open-nav hidden-md hidden-lg" data-move='>'><i class="fa fa-cog" aria-hidden="true"></i></div>
		</div>
		<div class="admin-main">
			<div class="admin-main-content">
				<form action="../../apps/brands.php" method="POST" enctype="multipart/form-data">
					<div class="admin-main-new-goods-top">
						<div class="admin-main-new-goods-top-name">
							<input type="text" placeholder="Назва бренду" name="name">
						</div>
						<div class="admin-main-new-goods-bot-picture-b">
