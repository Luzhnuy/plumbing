<?php include('../../configs/config.php'); $users = R::getAll("SELECT * FROM users WHERE type = 'client' ORDER BY username ASC"); ?>
<?php if ($_SESSION): ?>
			...
			<div class="admin-main-content">
				<div class="admin-main-list-first">
					...
					<div class="admin-main-list-actions-example">
						<div class="admin-main-list-action-change">Знижка</div>
					</div>
				</div>
				...
				<div class="admin-main-list-element">
					...
					<div class="admin-main-list-actions">
						<a><div class="admin-main-list-action-change setdiscount" data-discount="<?=$user['discount'];?>" data-name="<?=$user['username'];?>" data-id='<?=$user['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></div></a>
					</div>
				</div>
				<?php endforeach; ?>
			</div>
