				...
				<div class="container">
					<div class="row">
						<div class="com-xs-12 col-sm-8 col-md-6 col-md-offset-3">
							...
							<div class="sb-ware">
								<span class="sb-span"><!-- <span><img src="../img/star.png"></span> -->Оплата</span>
								<div class="row">
									<div class="col-xs-6 col-sm-6 col-md-6 border-right">
										<h3 class="h3">Через Liqpay</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit laboriosam dolorem obcaecati alias quod recusandae, consequuntur molestias accusantium dolorum et exercitationem, necessitatibus inventore. Recusandae vel ratione provident aut minima quo!</p>
									</div>
									<div class="col-xs-6 col-sm-6 col-md-6 border-right">
										<h3 class="h3">Готівкою</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit laboriosam dolorem obcaecati alias quod recusandae, consequuntur molestias accusantium dolorum et exercitationem, necessitatibus inventore. Recusandae vel ratione provident aut minima quo!</p>
									</div>
								</div>
							</div>
							<div class="sb-ware">
								<span class="sb-span"><!-- <span><img src="../img/star.png"></span> -->Доставка</span>
								<div class="row">
									<div class="col-xs-6 col-sm-6 col-md-6 border-right">
										<h3 class="h3">УкрПошта</h3>
										<!-- <div class="ware-img"><img src="../img/uapost.jpg"></div> -->
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati quas ipsa reiciendis sit laborum delectus, explicabo voluptatibus nemo ea earum, eveniet ducimus voluptates accusamus fuga magnam ut ratione atque sed.</p>
									</div>
									<div class="col-xs-6 col-sm-6 col-md-6 border-right">
										<h3 class="h3">Нова пошта</h3>
										<!-- <div class="ware-img"><img src="../img/newpost.png"></div> -->
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto ipsam quis non. Aut incidunt modi, cum omnis quidem obcaecati saepe facere quos dolores culpa nemo quae architecto eius nobis laudantium.</p>
									</div>
								</div>
							</div>
						</div>
